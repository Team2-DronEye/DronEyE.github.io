...
const translations = {
    "en": {
        ...
        "introText": "Discover the world from a new perspective with DRONEYE! Join the DRONEYE family today and unlock endless ways to explore every breathtaking view! Choose the subscription plan that suits you best!",
    ...
    "fr": {
        ...
        "tierTwo": 'Étage Voyageur a le meilleur valeur avec des nouvelles expériences! <a href="#AdventurerTier" class="buyButton">Voyageur</a>',
        ...
        "travelerTier": "À $20 par mois, les membres d'Étage Touriste recevront ce qui suit: <div style='margin-left: 40px'><ul><li>Exploration libre des grandes villes à traver le monde</li><li>5 heures de vol par chaque semaine!</li></ul></div>", 
        ...
        "globetrotterTier": "À $70 par mois, les membres d'Étage Globe-Trotteur recevront ce qui suit: <div style='margin-left: 40px'><ul><li>Tous les avantages des précédents Étages</li><li>Exploration entièrement libre</li><li>Rien de limite sur des heures de vol</li><li>Priorité absolue sur le choix du mod<le de drone</li></ul></div>"
    }
};
document.addEventListener('DOMContentLoaded', function() {
    translatePage('en'); 
